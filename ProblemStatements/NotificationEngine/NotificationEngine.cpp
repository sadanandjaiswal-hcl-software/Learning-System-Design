...
class EmailStrategy : public NotificationStrategy{
    ...
    public:
        ...
        void sendNotification(const string& content) override{
            cout<<"Sending Email Notificatoin to: "<<emailId<<" with content: "<<content<<endl;
        }
};
...
class SmsStrategy : public NotificationStrategy{
    ...
    public:
        ...
        void sendNotification(const string& content) override{
            cout<<"Sending Sms Notificatoin to: "<<mobileNumber<<" with content: "<<content<<endl;
        }
};
...
class PopupStrategy : public NotificationStrategy{
    public:
        void sendNotification(const string& content) override{
            cout<<"Sending Popup Notificatoin.."<<endl;
        }
};
...
int main() {
    ...
    Notification* notification = new TimeStampDecorator(new SignatureDecorator(new SimpleNotification("Hello World, this is my first notification"), "Customer Care"));
